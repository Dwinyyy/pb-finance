  ...
  return (
    <>
      ...
      >
        ...
        {mobileMenuOpen && (
          <div id="public-mobile-navigation" className="absolute z-50 max-h-[calc(100dvh-4rem)] w-full overflow-y-auto overscroll-contain border-t border-border-subtle bg-surface shadow-card lg:hidden md:max-h-[calc(100dvh-5rem)]" role="navigation" aria-label="Mobile navigation">
